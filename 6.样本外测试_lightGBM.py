...
if results_list:
    ...
    output_filename = 'test_results/lightGBM_returns.csv'
    ...
    output_img = 'plots/lightGBM_test_cumulative_returns_plot.png'
    ...
    # 保存性能统计
    performance_df.to_csv('test_results/lightGBM_performance_stats.csv')
    print("\n性能统计已保存至: test_results/lightGBM_performance_stats.csv")
