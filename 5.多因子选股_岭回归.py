...
if results_list:
    ...
    output_filename = 'train_results/Ridge_returns.csv'
    ...
    output_img = 'plots/Ridge_train_cumulative_returns_plot.png'
    ...
    # 保存性能统计
    performance_df.to_csv('train_results/Ridge_performance_stats.csv')
    print("\n性能统计已保存至: train_results/Ridge_performance_stats.csv")
