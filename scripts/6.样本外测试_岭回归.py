...
if results_list:
    ...
    output_filename = 'results/test_results/Ridge_returns.csv'
    ...
    output_img = 'results/plots/Ridge_test_cumulative_returns_plot.png'
    ...
    # 保存性能统计
    performance_df.to_csv('results/test_results/Ridge_performance_stats.csv')
    print("\n性能统计已保存至: results/test_results/Ridge_performance_stats.csv")
