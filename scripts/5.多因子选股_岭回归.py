...
if results_list:
    ...
    output_filename = 'results/train_results/Ridge_returns.csv'
    ...
    plt.title('Decile Portfolios Cumulative Returns (Pre-2023 Ridge Regression)',
    ...
    output_img = 'results/plots/Ridge_train_cumulative_returns_plot.png'
    ...
    # 保存性能统计
    performance_df.to_csv('results/train_results/Ridge_performance_stats.csv')
    print("\n性能统计已保存至: results/train_results/Ridge_performance_stats.csv")
